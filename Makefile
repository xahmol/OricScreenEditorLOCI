...
# assets/OSEDEMO{PJ,SC,CS}.BIN -- the same artwork in File > Load
# Project's 4-file scheme (no OSEDEMOCA.BIN -- this demo never touches
# CHARSET_ALT), added 2026-06-21 alongside the Combined-format file.
#
