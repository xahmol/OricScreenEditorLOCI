...
#define MSG_FILE_OVERWRITE_Q      "Fichier existe. Remplacer?"
#define MSG_FILE_PATH_TOO_LONG    "Chemin trop long."
#define MSG_FILE_PICKER_KEYS1     "UpDn:Dep L:Ret R:Ouvr Ent:Prendre"
#define MSG_FILE_PICKER_KEYS2     "T/B:Haut/Bas D/P:PgDn/PgUp E:Creer"
#define MSG_FILE_PICKER_KEYS3     "\\:Racine ,.:Lecteur Esc:Annuler"
#define MSG_FILE_PICKER_NEWDIR    "Nom du nouveau dossier:"
#define MSG_FILE_PICKER_NEWFILE   "<nouveau fichier>"
