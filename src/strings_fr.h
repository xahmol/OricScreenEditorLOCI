...
// FR title screen and help screens are separate files (OSETSF.BIN /
// OSEHF{1-4}.BIN) so each language gets its own translated assets.
// Generated by tools/patch_title_screen.py and tools/gen_help_screens.py.
#define MSG_TITLE_SCREEN_FILE  "OSETSF.BIN"
#define MSG_HELP_SCREEN_PREFIX "OSEHF"
