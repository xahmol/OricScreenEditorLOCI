...
check_bytes "row0 = . . A . ." "0xBB80:5" "20 20 41 20 20" "$DUMP1"
check_bytes "row1 = . A A A ." "0xBBA8:5" "20 41 41 41 20" "$DUMP1"
check_bytes "row2 = A A A A A" "0xBBD0:5" "41 41 41 41 41" "$DUMP1"
check_bytes "row3 = . A A A ." "0xBBF8:5" "20 41 41 41 20" "$DUMP1"
check_bytes "row4 col4 = a0 (cursor-inverted blank, outside ellipse)" "0xBC24:1" "a0" "$DUMP1"
...
check_bytes "row0 = . . A . ." "0xBB80:5" "20 20 41 20 20" "$DUMP2"
check_bytes "row1 = . A . A ." "0xBBA8:5" "20 41 20 41 20" "$DUMP2"
check_bytes "row2 = A . . . A" "0xBBD0:5" "41 20 20 20 41" "$DUMP2"
check_bytes "row3 = . A . A ." "0xBBF8:5" "20 41 20 41 20" "$DUMP2"
...
check_bytes "row0 = AAAAA (filled box, no ellipse)" "0xBB80:5" "41 41 41 41 41" "$DUMP3"
check_bytes "row2 = AAAAA" "0xBBD0:5" "41 41 41 41 41" "$DUMP3"
